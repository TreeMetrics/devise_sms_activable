    ...
    module SmsActivable
      ...
      protected
        ...
        module ClassMethods
          ...
          Devise::Models.config(self, :sms_confirm_within, :sms_confirmation_keys, :sms_model_attribute, :sms_code_symbols, :prevent_sms_sending, :use_predefined_sms_code, :confirmation_code_expiration_time, :sms_code_length)
        end
    end
  end
end
